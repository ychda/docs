...
1. [GitHub](https://github.com/ychda)
1. [Django 文档](https://docs.djangoproject.com/zh-hans/4.0/)
1. [Scrapy](https://scrapy.org/)
1. [VuePress 2](https://v2.vuepress.vuejs.org/zh/)
1. [VitePress](https://vitepress.vuejs.org/)
...
1. [The Big Read](https://en.wikipedia.org/wiki/The_Big_Read?wprov=sfla1)
